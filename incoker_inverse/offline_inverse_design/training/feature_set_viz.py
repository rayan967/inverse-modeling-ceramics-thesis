"""Analyze the performance of Gaussian Process Regression (GPR) models with kernels and feature sets on ceramic data."""
...
def perform_grid_search(X, Y, property_index, feature_set):
    """Perform grid search to optimize Gaussian Process model parameters for a given property."""
    y = Y[:, property_index]
